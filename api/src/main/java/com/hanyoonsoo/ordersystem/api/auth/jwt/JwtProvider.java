...
import com.hanyoonsoo.ordersystem.api.auth.config.JwtSecurityProperties;
...
public class JwtProvider {
    ...
    private JwtUserClaims validateAndExtractUserClaims(String token) {
        ...
        try {
            ...
            throw new JwtAuthenticationException(ErrorCode.INVALID_TOKEN, ErrorCode.INVALID_TOKEN.message("invalid subject"), e);
        }
    ...
    private Claims parseClaims(String token) {
        try {
            ...
            throw new JwtAuthenticationException(ErrorCode.ACCESS_TOKEN_EXPIRED, ErrorCode.ACCESS_TOKEN_EXPIRED.getMessage(), e);
        } catch (UnsupportedJwtException | MalformedJwtException | SignatureException | IllegalArgumentException e) {
            throw new JwtAuthenticationException(ErrorCode.INVALID_TOKEN, ErrorCode.INVALID_TOKEN.getMessage(), e);
        } catch (Exception e) {
            throw new JwtAuthenticationException(ErrorCode.INVALID_TOKEN, ErrorCode.INVALID_TOKEN.message("token parse failed"), e);
        }
    }
    ...
    private static Role toRole(String roleName) {
        try {
            ...
            throw new JwtAuthenticationException(ErrorCode.INVALID_TOKEN, ErrorCode.INVALID_TOKEN.message("invalid role: " + roleName), e);
        }
    }
